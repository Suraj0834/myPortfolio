      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <div className="flex-1">
            ...
            I am a student at the Lovely Professional University with a major in Computer Science. I have a passion for computer programming and information technology. I have used computer programming since I was in secondary school. This passion has given me the ability to learn programs for a multitude of things, including robots, programming languages, and databases.
